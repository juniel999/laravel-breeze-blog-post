<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 h-[5rem]">
            <div class="flex">
                <!-- Logo -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else 
                <x-nav-link :href="route('login')" :active="request()->routeIs('posts')">
                    {{ __('Login') }}
                </x-nav-link>
                <x-nav-link :href="route('register')" :active="request()->routeIs('posts')">
                    {{ __('Register') }}
                </x-nav-link>
                @endif
            </div>
